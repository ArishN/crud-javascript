...
var taskconent ='';
    task_array.map((task_keys,index)=>{
      ...
      <div class="content_container my-3 col-md-10 p-2">
        ...
        <button class="col-6 btn btn-success edit_btn"  data-bs-toggle="modal" data-bs-target="#modaledit-${index}"><i class="bi bi-pencil-fill"></i></button>
       
        <button class="btn col-6 btn-danger delete_btn" id="delete_btn" data-index="${index}"><i class="bi bi-trash3-fill"></i></button>
    </div>
        </div>
        </div>
